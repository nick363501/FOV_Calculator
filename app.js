...
var FOCAL_CONFIGS = [
  ...
  {focal:1422,label:"Edge Reducer-1422-f/7", color:"#e67c19ff"},s
  {focal:2032,label:"Edge Native-2032-f/10", color:"#19c7e6ff"}
];
...
function computeTonightBest(lat, lon, date, minAlt){
  ...
  return {list: results.slice(0,25), window: win, noon: noon, nextNoon: nextNoon, sunCurve: sunCurve};
}
